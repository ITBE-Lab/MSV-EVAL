...
only_sv = True
no_sv = False
def duplication(sv_size, gap_size, genome_section, ref_start):
    seeds = Seeds()
    ...
    read += g[ref_start + offset + sv_size + gap_size:len(genome_section)-sv_size]
...
print_binary_search_plot("duplication_overlap", "SV Overlap - Duplication", sv_size_max=500)